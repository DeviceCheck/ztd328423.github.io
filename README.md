...
| 类库  | 应用架构|
|-------|---------|
|[Android 复习资料](https://github.com/Carson-Ho)|Android 这是一份详细的RxJava学习攻略 & 指南|
...
|[android soter](https://github.com/Tencent/soter/wiki)|android 指纹识别和人脸识别支付功能|
|[android Ericsongyl](https://github.com/Ericsongyl)|AOSF：全称为Android Open Source Framework，即Android优秀开源框架汇总。包含：网络请求okhttp，图片下载glide，数据库greenDAO，链式框架RxJava，组件路由ARouter，消息传递通信EventBus，热更新Tinker，插件化框架Replugin，文件下载FileDownloaer，图片选择PhotoPicker，图片滤镜/毛玻璃等特…|
...
|[Android iReaderAndroid](https://github.com/iReaderAndroid)| ZeusPlugin成熟易懂的Android插件补丁框架（可直接商业化的项目，日活千万级项目多年使用验证稳定） |
...
|[android audioplayers](https://github.com/luanpotter/audioplayers)|Android audio icon 开始结束 进中|
...
|[android free api](https://github.com/fangzesheng/free-api)|收集免费的接口服务,做一个api的搬运工|
|[android flutter app](https://github.com/shichunlei/flutter_app)|android app 🔥🔥🔥本项目包括各种基本控件使用豆瓣电影、每日一文、和天气、百姓生活、随机诗词、联系人、句子迷、好奇心日报等板块|
|[android SmartSwipe](https://github.com/luckybilly)|An android library to make swipe more easier and more powerful. 关于侧滑，有这一个就够了 https://juejin.im/post/5d3fdc3af265da…|
...
|[Android 面试](https://github.com/Moosphan)|面试指南|
...
|[ScalingLayout](https://github.com/iammert/ScalingLayout)|android 可以缩放layout|
